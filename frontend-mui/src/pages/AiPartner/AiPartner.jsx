...
export default function AiPartner() {
  ...
  return (
    <Box>
      <Typography variant="h6" sx={{ fontWeight: 800, color: '#1e293b', mb: 2 }}>選擇 AI 夥伴</Typography>
            ...
            >
              ...
              >
                ...
                <Typography sx={{ fontWeight: 700, color: '#1e293b', mb: 0.5 }}>
                  {partner.name}
                  {partner.builtin && (
                    <Chip label="預設" size="small" sx={{ ml: 1, fontSize: 11, height: 20, bgcolor: '#e8ebf5', color: '#1e2d52', fontWeight: 700 }} />
                  )}
                </Typography>
