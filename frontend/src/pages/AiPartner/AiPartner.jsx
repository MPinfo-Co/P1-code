    ...
    <div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 mb-5">
        <div className="flex items-center gap-3">
          <label className="text-sm font-medium text-slate-600 whitespace-nowrap">關鍵字搜尋:</label>
          <input
            type="text"
            value={keyword}
      ...
      <div className="grid gap-5" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))' }}>
        {filtered.map(partner => (
          ...
          >
            {partner.builtin ? (
              <svg className="w-12 h-12 mx-auto mb-4 stroke-[#2e3f6e] fill-none" strokeWidth="1.5" viewBox="0 0 24 24">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                <path d="M12 8v4" /><path d="M12 16h.01" />
              </svg>
            ) : (
              <svg className="w-12 h-12 mx-auto mb-4 fill-none" strokeWidth="1.5" viewBox="0 0 24 24" stroke={partner.disabled ? '#94a3b8' : '#2e3f6e'}>
