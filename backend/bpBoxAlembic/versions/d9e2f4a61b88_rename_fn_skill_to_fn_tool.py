...
def upgrade() -> None:
    ...
    op.drop_index(
        "idx_tb_skill_body_params_skill_id", table_name="tb_skill_body_params"
    )
    op.drop_constraint(
        "tb_skill_body_params_skill_id_fkey", "tb_skill_body_params", type_="foreignkey"
    )
    ...
    op.create_index(
        "idx_tb_tool_body_params_tool_id", "tb_tool_body_params", ["tool_id"]
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "tb_tool_body_params_tool_id_fkey", "tb_tool_body_params", type_="foreignkey"
    )
    ...
    op.create_index(
        "idx_tb_skill_body_params_skill_id", "tb_skill_body_params", ["skill_id"]
    )
