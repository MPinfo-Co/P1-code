"""ORM models for fn_ai_partner_config: tb_ai_partners, tb_ai_partner_configs, tb_ai_partner_tools."""
...
class AiPartnerConfig(Base):
    """AI 夥伴設定主表，對應 tb_ai_partner_configs。"""
...
class AiPartnerTool(Base):
    """AI 夥伴設定與工具的多對多關聯，對應 tb_ai_partner_tools。"""
