"""ORM models for fn_ai_partner_tool: tb_tools, tb_tool_body_params, tb_tool_web_scraper_configs."""
...
class Tool(Base):
    ...
    custom_table_id: Mapped[int | None] = mapped_column(
        Integer, ForeignKey("tb_custom_tables.id"), nullable=True
    )
